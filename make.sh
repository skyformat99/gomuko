...
g++ source/FinisherTest.cpp source/Finisher.cpp  source/Analyzer.cpp source/Config.cpp source/Score.cpp source/logger.cpp source/gameMap.cpp source/mapDriver.cpp source/struct/Color.cpp -o build/finisherTest.out

g++ main.cpp source/Config.cpp source/Finisher.cpp source/Analyzer.cpp source/logger.cpp source/Game.cpp source/Score.cpp source/winChecker.cpp source/LevelProcessor.cpp source/gameMap.cpp source/mapDriver.cpp source/struct/Color.cpp source/struct/Result.cpp source/struct/Counter.cpp -O3 -o build/run.out

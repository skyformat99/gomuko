...
g++ main.cpp source/Config.cpp source/Analyzer.cpp source/logger.cpp source/Game.cpp source/Score.cpp source/winChecker.cpp source/LevelProcessor.cpp source/gameMap.cpp source/mapDriver.cpp source/struct/Color.cpp source/struct/Result.cpp source/struct/Counter.cpp -o build/run.out
